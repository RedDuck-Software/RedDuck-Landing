      ...
      <div className="mission-items">
        <div className="mission-items-item">
          ...
          <p className="mission-items-item-text">
            Our mission is to make every enterprise more intelligent and secure,
            by utilizing blockchain technologies.
          </p>
        </div>
        <div className="mission-items-item">
          <div className="mission-items-item-illustration">
          ...
          <p className="mission-items-item-text">
            We provide powerful software solutions and expert services that
            enable everyone to use innovative technologies.
          </p>
        </div>
        <div className="mission-items-item">
          <div className="mission-items-item-illustration">
          ...
          <p className="mission-items-item-text">
            We want to bring the world to mass crypto adoption and include it in
            all areas of activity life.
          </p>
        </div>
      </div>
      <Texture

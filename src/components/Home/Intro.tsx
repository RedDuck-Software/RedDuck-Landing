  ...
  return (
    <section className='intro'>
      ...
      <div className="intro-right">
        <img loading="lazy" onClick={() => {setIsVideoOpened(!isVideoOpened)}} src={PlayButton} alt="Button" className='intro-right-button'/>
      ...
      <img loading="lazy" src={introChart} className="intro-chart" alt='intro-chart'/>

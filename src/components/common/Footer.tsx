      ...
      <div className="footer-parts">
        ...
        <div className="footer-parts-right">
          <div className="footer-parts-right-pages">
            ...
            <p>
              <Link to="/cases">Partners & cases</Link>
            </p>
            <p>
          ...
          <p className="footer-parts-right-address">
            © 2023. All rights reserved. <br />
            Akademika Pavlova 155 Street, Kharkiv, Ukraine
          </p>
          <div className="footer-parts-right-socials">
            <a
              href="https://jobs.dou.ua/companies/red-duck/"
              className="footer-parts-right-socials-icon"
            >
              <img loading="lazy" src={DouLogo} alt="Dou" />
            </a>
            <a
              href="https://www.facebook.com/profile.php?id=100076952286530"
              className="footer-parts-right-socials-icon"
            >
              <FacebookIcon />
            </a>
            <a
              href="https://redduck.medium.com/"
              className="footer-parts-right-socials-icon"
            >
              <img loading="lazy" src={MediumLogo} alt="Dou" id="medium" />
            </a>
            <a
              href="https://www.linkedin.com/company/redduckdev/"
              className="footer-parts-right-socials-icon"
            >
              <LinkedinIcon />
            </a>

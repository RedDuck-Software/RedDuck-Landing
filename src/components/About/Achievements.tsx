...
export const Achievements = () => {
  ...
  const achievementsList = [
    ...
    },
    {
      ...
      date: '06. 2021',
      title: [
        'Our first development of PlayToEarn game: ',
        <a key={'000'} href="https://www.crimecash.biz/">
          crimecash.biz
        </a>,
      ],
    ...
    },
    {
      ...
      date: '08. 2021:',
      title: [
        'Our first development af a DevTool for blockchain developers - ',
        <a
          key={111}
          href="https://github.com/RedDuck-Software/SolidityProvider"
        >
          github.com
        </a>,
      ],
    ...
    },
    {
      ...
      date: '02. 2022',
      title: [
        'Started our volunteering initiative in Ukraine - ',
        <a key={222} href="https://buggydao.redduck.io/">
          buggydao.redduck.io
        </a>,
      ],
    ...
    },
    {
      ...
      date: '07. 2022',
      title: [
        'Started development of our own launchpad - ',
        <a key={333} href="https://launchpad.redduck.io/">
          launchpad.redduck.io
        </a>,
      ],
    ...
    },
    {
      ...
      date: '09. 2022',
      title: [
        'RedDuck took second place in the Kyiv Tech Summit, a WEB3 hackathon ',
        <a key={444} href="https://www.kyivtechsummit.com">
          kyivtechsummit.com
        </a>,
      ],
  ...
  return (
    <section className="achievements">
        ...
        {achievementsList.map((item) => (
          <div key={item.id} className="achievements-list-item">
            <div className="achievements-list-item-left">
              <div className="achievements-list-item-left-id">
                {item.id + 1}
              </div>
              <div className="achievements-list-item-left-date">
                {item.date}
              </div>
            </div>
            <div className="arrows">
              <img
                ...
                src={RoadmapArrow}
                alt="Arrow"
                className="achievements-list-item-roadmap"
              />
      ...
      <ScrollArrow />
      <SectionTitle>
        {isMobile ? 'We Provide' : 'Services We Provide'}
      </SectionTitle>
    </section>
  );
};
